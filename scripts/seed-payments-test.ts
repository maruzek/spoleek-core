...
const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    workspaceEmail: true,
    note: "Pending but already past due — the cron flips it to overdue, suspends the member and sends the overdue email.",
  },
  {
    key: "overdue",
    lastName: "Overdue",
    ...
    workspaceEmail: true,
    note: "Already overdue and suspended. Marking it paid must flip the member back to active.",
  },
  {
    key: "paid",
    lastName: "Paid",
