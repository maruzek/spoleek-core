      ...
      if (hasMembersTableColumn) {
        await db
          ...
          .set({
            ...
            showGroupsToNonMembers: parsedInput.showGroupsToNonMembers,
            groupPagesVisibleToAllMembers: parsedInput.groupPagesVisibleToAllMembers,
    ...
    if (parsedInput.id) {
      ...
      await db
        ...
        .set({
          ...
          pageVisibility: parsedInput.pageVisibility,
          isActive: parsedInput.isActive,
          sortOrder: parsedInput.sortOrder,
          ...feeFields,
