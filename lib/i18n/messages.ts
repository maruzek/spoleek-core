...
const en = {
  ...
  portalGroupPage: {
    ...
    events: "Events",
    upcoming: "Upcoming",
    alsoInvited: "Also invited to",
    alsoInvitedHint: "Organised elsewhere, open to this group.",
...
const cs: Dictionary = {
  ...
  portalGroupPage: {
    ...
    events: "Akce",
    upcoming: "Nadcházející",
    alsoInvited: "Pozvánky odjinud",
    alsoInvitedHint: "Pořádá někdo jiný, otevřeno této skupině.",
    pastEvents: "Proběhlé akce",
