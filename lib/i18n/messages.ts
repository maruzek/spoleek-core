...
const en = {
  ...
  common: {
    ...
    copy: "Copy",
    copied: "Copied",
    copyFailed: "Clipboard is not available in this browser.",
  ...
  portalGroups: {
    ...
    you: "(you)",
    copyEmailOf: (name: string) => `Copy ${name}'s email`,
    nextUp: "Next up",
  ...
  portalGroupPage: {
    ...
    announcementBy: (date: string, name: string | null) =>
      name ? `Updated ${date} by ${name}` : `Updated ${date}`,
    announcementEmpty: "Nothing on the board yet. Write a note for the group.",
    edit: "Edit",
    // Standing
    ...
    since: "Member since",
    fee: "Membership fee",
    feeRenews: (date: string) => `Renews ${date}`,
    feeStatus: {
      pending: "To pay",
      overdue: "Overdue",
      paid: "Paid",
    ...
    needsYou: "Needs you",
    // Tabs
    tabs: { overview: "Overview", events: "Events", forms: "Forms", members: "Members" },
    // Events
    events: "Events",
    now: "Now",
    upcoming: "Upcoming",
    ...
    invitedBadge: "Invited",
    sourceAll: "All",
    sourceOwned: "This group",
    sourceInvited: "Invited to",
    sourceLabel: "Source",
    ...
    nothingNow: "Nothing is running right now.",
    ...
    forms: "Forms",
    openForms: "Open",
    answeredForms: "Answered earlier",
    noForms: "Nothing to fill in right now.",
    // Resources
    resources: "Links & resources",
    noResources: "No links yet.",
    noResourcesManager: "Add the links the group lives by — a chat, a shared folder, a calendar.",
    editLinks: "Edit links",
    // Roster
    roster: "Members",
    leadersHeading: "Leaders",
    membersHeading: "Members",
    copyLeaderEmails: "Copy leader emails",
    copyEmail: "Copy email",
    rosterHint: "Only members of this group see this list.",
    you: "(you)",
    leaderBadge: "Leader",
    // Leader panel
    ...
    announcementEditorDescription:
      "Everyone who can open this page sees the board. Links open in a new tab.",
    save: "Save",
    saving: "Saving…",
    cancel: "Cancel",
    announcementSaved: "Notice board updated.",
    announcementCleared: "Notice board cleared.",
    // Resources editor
    resourcesEditorDescription: (max: number) =>
      `Up to ${max} links, shown in this order. Web addresses and mailto: links only.`,
    label: "Label",
    labelPlaceholder: "Team chat",
    url: "Link",
    ...
    moveDown: "Move down",
    remove: "Remove",
    resourcesSaved: "Links saved.",
    failed: "That did not work. Try again.",
    // Profile
    hideFromRosters: "Do not list me in group rosters",
    hideFromRostersDescription:
      "Other members of your groups will not see your name in the members list. Leaders still see you in the admin, and you stay listed as a leader where you are one.",
    hideFromRostersSaved: "Preference saved.",
  },
...
const cs: Dictionary = {
  ...
  common: {
    ...
    copy: "Kopírovat",
    copied: "Zkopírováno",
    copyFailed: "Schránka není v tomto prohlížeči dostupná.",
  ...
  portalGroups: {
    ...
    you: "(vy)",
    copyEmailOf: (name: string) => `Kopírovat e-mail: ${name}`,
    ...
    askLeader: "Kopírovat e-mail vedoucího",
  ...
  portalGroupPage: {
    ...
    announcementBy: (date: string, name: string | null) =>
      name ? `Upraveno ${date}, ${name}` : `Upraveno ${date}`,
    announcementEmpty: "Na nástěnce zatím nic není. Napište skupině vzkaz.",
    edit: "Upravit",
    standing: "Vaše členství",
    role: "Role",
    leaderRole: "Vedoucí",
    memberRole: "Člen",
    since: "Členem od",
    fee: "Členský příspěvek",
    feeRenews: (date: string) => `Obnova ${date}`,
    feeStatus: {
      pending: "K zaplacení",
      overdue: "Po splatnosti",
      paid: "Zaplaceno",
      refund_due: "K vrácení",
      cancelled: "Zrušeno",
    } as Record<string, string>,
    viewPayments: "Platby",
    needsYou: "Čeká na vás",
    tabs: { overview: "Přehled", events: "Akce", forms: "Formuláře", members: "Členové" },
    events: "Akce",
    now: "Probíhá",
    upcoming: "Nadcházející",
    pastEvents: "Proběhlé",
    invitedBadge: "Pozvánka",
    sourceAll: "Vše",
    sourceOwned: "Tato skupina",
    sourceInvited: "Pozvánky",
    sourceLabel: "Zdroj",
    answerLabel: "Vaše odpověď",
    searchEvents: "Hledat akce…",
    sortSoonest: "Nejbližší první",
    sortLatest: "Nejnovější první",
    showAll: (count: number) => `Zobrazit všech ${count}`,
    showFewer: "Zobrazit méně",
    nothingNow: "Právě teď nic neprobíhá.",
    nothingUpcoming: "Zatím nic naplánováno.",
    nothingPast: "Zatím žádné proběhlé akce.",
    noMatch: "Filtrům nic neodpovídá.",
    forms: "Formuláře",
    openForms: "Otevřené",
    answeredForms: "Dříve vyplněné",
    noForms: "Teď není co vyplňovat.",
    resources: "Odkazy a zdroje",
    noResources: "Zatím žádné odkazy.",
    noResourcesManager: "Přidejte odkazy, které skupina používá — chat, sdílenou složku, kalendář.",
    editLinks: "Upravit odkazy",
    roster: "Členové",
    leadersHeading: "Vedoucí",
    membersHeading: "Členové",
    copyLeaderEmails: "Kopírovat e-maily vedoucích",
    copyEmail: "Kopírovat e-mail",
    rosterHint: "Tento seznam vidí jen členové skupiny.",
    you: "(vy)",
    leaderBadge: "Vedoucí",
    ...
    manageInAdmin: "Spravovat v administraci",
    announcementEditorDescription:
      "Nástěnku vidí každý, kdo může otevřít tuto stránku. Odkazy se otevírají v nové záložce.",
    save: "Uložit",
    saving: "Ukládám…",
    cancel: "Zrušit",
    announcementSaved: "Nástěnka upravena.",
    announcementCleared: "Nástěnka vymazána.",
    resourcesEditorDescription: (max: number) =>
      `Nejvýše ${max} odkazů, v tomto pořadí. Jen webové adresy a odkazy mailto:.`,
    label: "Název",
    labelPlaceholder: "Týmový chat",
    url: "Odkaz",
    urlPlaceholder: "https://",
    ...
    remove: "Odebrat",
    resourcesSaved: "Odkazy uloženy.",
    failed: "To se nepodařilo. Zkuste to znovu.",
    hideFromRosters: "Neuvádět mě v seznamech členů skupin",
    hideFromRostersDescription:
      "Ostatní členové vašich skupin vaše jméno v seznamu členů neuvidí. Vedoucí vás v administraci vidí dál a tam, kde skupinu vedete, zůstáváte uvedeni jako vedoucí.",
    hideFromRostersSaved: "Předvolba uložena.",
  },
